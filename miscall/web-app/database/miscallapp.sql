...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2021 at 09:39 AM
...
--
-- Table structure for table `tbl_assigned_numbers`
--

CREATE TABLE `tbl_assigned_numbers` (
  `assigned_id` int(11) NOT NULL,
  `procured_no_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `status` enum('assigned','unassigned','deleted') NOT NULL DEFAULT 'assigned'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `tbl_bd_agents`
--
...
--
-- Dumping data for table `tbl_bd_agents`
--

INSERT INTO `tbl_bd_agents` (`id`, `bd_name`, `dept_id`, `email`, `contact_no`, `date`) VALUES
(2, 'Anbu', 3, 'abu@gmail.com', '8299502081', '2021-02-23'),
(3, 'Maheshwari', 2, 'maheshwari@gmail.com', '8299502081', '2021-02-23'),
(4, 'Mohit', 6, 'mohit@way2mint.com', '8299502081', '2021-02-23'),
(5, 'Komal', 2, 'komal@way2mint.com', '8299502081', '2021-02-23'),
(6, 'preeti', 4, 'preeti@way2mint.com', '8299502081', '2021-02-23'),
(7, 'vivek', 6, 'vivek@way2mint.com', '8299502081', '2021-02-23'),
(8, 'awnish', 4, 'awnish@way2mint.com', '8299502081', '2021-02-23');
...
INSERT INTO `tbl_dept` (`id`, `department`) VALUES
...
INSERT INTO `tbl_login` (`login_id`, `auth_id`, `auth_pass`, `role_id`, `user_id`) VALUES
(20, 'admin', '2959764d31389e9e70285f258f006a3a', 1, NULL),
(21, 'user', '2959764d31389e9e70285f258f006a3a', 2, NULL),
(22, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 5),
(23, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 6),
(24, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 7),
(25, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 8),
(26, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 9),
(27, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 10),
(28, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 11),
(29, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 12),
(30, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 13),
(31, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 14),
(32, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 17),
(33, 'awnish@gmail.com', '2959764d31389e9e70285f258f006a3a', 2, 18);
...
(2, 'menu_data_filter', 'Data Filter'),
(3, 'menu_logs', 'Logs'),
(4, 'menu_channer_partner', 'Channer Partner'),
...
CREATE TABLE `tbl_permission` (
  ...
  `menu_data_filter` int(11) DEFAULT 0,
  `menu_logs` int(11) NOT NULL DEFAULT 0,
  `menu_channer_partner` int(11) NOT NULL DEFAULT 0,
  `menu_user_account` int(11) NOT NULL DEFAULT 0,
  `menu_other` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_permission` (`id`, `login_id`, `menu_dashboard`, `menu_data_filter`, `menu_logs`, `menu_channer_partner`, `menu_user_account`, `menu_other`) VALUES
(1, 2, 1, 0, 0, 0, 0, 0),
(2, 29, 1, 0, 1, 1, 1, 1),
(3, 30, 1, 0, 1, 1, 1, 1),
(4, 31, 1, 0, 1, 1, 1, 1),
...
--
-- Table structure for table `tbl_procured_numbers`
--

CREATE TABLE `tbl_procured_numbers` (
  `id` int(11) NOT NULL,
  `prefix_code` int(11) NOT NULL,
  `miscall_numbers` bigint(11) NOT NULL,
  `vendor_id` int(11) NOT NULL,
  `activation_date` varchar(80) NOT NULL,
...
--
-- Dumping data for table `tbl_procured_numbers`
--

INSERT INTO `tbl_procured_numbers` (`id`, `prefix_code`, `miscall_numbers`, `vendor_id`, `activation_date`, `months`, `is_assigned`, `status`) VALUES
(2, 91, 8299502081, 1, '2021-02-18', 8, 0, 'active'),
(3, 91, 8299502081, 1, '2021-02-18', 12, 0, 'active'),
(4, 91, 8299502081, 1, '2021-02-24', 10, 0, 'active'),
(5, 91, 8299502081, 3, '2019-09-18', 9, 0, 'inactive');
...
CREATE TABLE `tbl_role_permission` (
  ...
  `role_id` int(11) NOT NULL,
  `menu_dashboard` int(11) NOT NULL DEFAULT 1,
  `menu_data_filter` int(11) DEFAULT 1,
  `menu_logs` int(11) NOT NULL DEFAULT 1,
  `menu_channer_partner` int(11) NOT NULL DEFAULT 1,
...
INSERT INTO `tbl_role_permission` (`id`, `role_id`, `menu_dashboard`, `menu_data_filter`, `menu_logs`, `menu_channer_partner`, `menu_user_account`, `menu_other`) VALUES
(1, 1, 1, 1, 1, 1, 1, 1),
(2, 2, 1, 0, 1, 0, 0, 0);
...
INSERT INTO `tbl_uploads` (`upload_id`, `client_ip`, `login_id`, `file_name`, `file_type`, `extension`, `size`, `date`, `time`, `status`) VALUES
(7, '::1', 1, '20210220130006', '', 'csv', '14.88 MB', '2021-02-20', '13:00:07', 'uploaded');
...
(1, 'awnish', 'awnish company', 'awnish@gmail.com', 8299502081, 226577, 'company is good', 2, 'enable', NULL, 5),
(2, 'awnish', 'awnish company', 'awnish@gmail.com', 8299502081, 226577, 'company is good', 2, 'enable', NULL, 5),
(3, 'awnish', 'awnish company', 'awnish@gmail.com', 8299502081, 226577, 'company is good', 2, 'enable', NULL, 5),
(4, 'awnish', 'awnish company', 'awnish@gmail.com', 8299502081, 226577, 'company is good', 2, 'enable', NULL, 5),
(5, 'awnish', 'awnish company', 'awnish@gmail.com', 8299502081, 226577, 'company is good', 2, 'enable', NULL, 5),
(6, '.htaccess', 'awnish company', 'mohit@way2mint.com', 8299502081, 226577, 'wertyu', 7, 'enable', NULL, 5),
(7, '.htaccess', 'awnish company', 'mohit@way2mint.com', 8299502081, 226577, 'wertyu', 7, 'enable', NULL, 5),
(8, '.htaccess', 'awnish company', 'mohit@way2mint.com', 8299502081, 226577, 'wertyu', 7, 'enable', NULL, 5),
(9, '.htaccess', 'awnish company', 'mohit@way2mint.com', 8299502081, 226577, 'wertyu', 7, 'enable', NULL, 5),
(10, '.htaccess', 'awnish company', 'mohit@way2mint.com', 8299502081, 226577, 'wertyu', 7, 'enable', NULL, 5),
(11, '.htaccess', 'awnish company', 'mohit@way2mint.com', 8299502081, 226577, 'wertyu', 7, 'enable', NULL, 5),
(12, '.htaccess', 'awnish company', 'mohit@way2mint.com', 8299502081, 226577, 'wertyu', 7, 'enable', NULL, 5),
(13, '.htaccess', 'awnish company', 'mohit@way2mint.com', 8299502081, 226577, 'wertyu', 7, 'enable', NULL, 5),
(14, '.htaccess', 'awnish company', 'mohit@way2mint.com', 8299502081, 226577, 'wertyu', 7, 'enable', NULL, 5),
(15, 'Testing', 'Test Company', 'company@test.com', 8299502081, 226577, 'Company of Google', 8, 'enable', NULL, 5),
(16, 'awnish', 'awnish company', 'awnishmmg.a41@gmail.com', 8299502081, 226577, '123456', 5, 'enable', NULL, 5),
(17, 'awnish', 'awnish company', 'awnishmmg.a41@gmail.com', 8299502081, 226577, '12345678', 7, 'enable', NULL, 5),
(18, 'awnish', 'awnish company', 'awnishmmg.a41@gmail.com', 8299502081, 226577, '12345678', 7, 'enable', NULL, 5);
...
CREATE TABLE `tbl_user_billing` (
  ...
  `billing_cost` varchar(50) NOT NULL,
  `billing_units` varchar(50) NOT NULL,
...
CREATE TABLE `tbl_vendors` (
  `id` int(11) NOT NULL,
  `vendors_name` varchar(255) NOT NULL,
  `description` text NOT NULL,
  `since` varchar(80) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_vendors` (`id`, `vendors_name`, `description`, `since`) VALUES
(1, 'Knowlarity', 'This sis Testing', '2021-02-17'),
(2, 'My Operator', 'My Operator is Telecom Service Registered with us', '2021-02-17'),
(3, 'Cubix', 'Cubix is Operator Registered with Us', '2021-02-17');
...
--
-- Indexes for table `tbl_assigned_numbers`
--
ALTER TABLE `tbl_assigned_numbers`
  ADD PRIMARY KEY (`assigned_id`);

--
-- Indexes for table `tbl_bd_agents`
--
ALTER TABLE `tbl_bd_agents`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_procured_numbers`
--
ALTER TABLE `tbl_procured_numbers`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_user_billing`
--
ALTER TABLE `tbl_user_billing`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_assigned_numbers`
--
ALTER TABLE `tbl_assigned_numbers`
  MODIFY `assigned_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_bd_agents`
--
ALTER TABLE `tbl_bd_agents`
...
--
-- AUTO_INCREMENT for table `tbl_procured_numbers`
--
ALTER TABLE `tbl_procured_numbers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT for table `tbl_user_billing`
--
ALTER TABLE `tbl_user_billing`
